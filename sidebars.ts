...
const sidebars: SidebarsConfig = {
  docsSidebar: [
    ...
    {type: 'category', label: 'MiniJAM', link: {type: 'doc', id: 'minijam/index'}, collapsed: false, items: [
      ...
      {type: 'category', label: 'Run MiniJAM', items: ['minijam/operators/local-environment', 'minijam/operators/run-a-worker']},
      {type: 'category', label: 'Concepts', items: ['minijam/concepts/execution-pipeline']},
      {type: 'category', label: 'Reference', items: ['minijam/reference/host-calls']},
